...
// Question 4. Develop a simple two-player game (like Tic-Tac-Toe) using a minimax algorithm represented
// as a game tree. Allow players to make moves and compute the best possible move for the AI.
